...
(defn bottom-part
  ...
  (list
    ...
    (divider)
    [:p {:class (css :my-2)}
     "Since I am inspired by Dawkins, Dennett, Deutsch, Marletto and Blackmore, the meme people, I want to make that a memetics."
     " What are genotypes, vehicles, phenotypes, extended phenotypes of software animals?"
     " The meme-view would emphasize adaptation, design, compositionality, 'good tricks that are hard to vary'."]))
